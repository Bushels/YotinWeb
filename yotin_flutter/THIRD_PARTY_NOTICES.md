...
The following font files are distributed with this Field Review artifact so it
does not make runtime requests to a third-party font CDN:

- Archivo Bold — Copyright 2020 The Archivo Project Authors
  (<https://github.com/Omnibus-Type/Archivo>)
- Space Grotesk Bold — Copyright 2020 The Space Grotesk Project Authors
  (<https://github.com/floriankarsten/space-grotesk>)
- IBM Plex Sans Regular and IBM Plex Mono Medium — Copyright 2017 IBM Corp.
  with Reserved Font Name "Plex"
- Roboto Regular — Copyright 2011 The Roboto Project Authors
  (<https://github.com/googlefonts/roboto-classic>)

The engine-compatible Roboto fallback under `assets/fonts/roboto/v32/` is an
unmodified duplicate of the bundled Roboto Regular file. All listed fonts are
provided under the SIL Open Font License, Version 1.1.
