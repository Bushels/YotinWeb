...
export function buildWellSystem(paths, mats) {
  ...
  const shell = new THREE.Mesh(
    new THREE.TubeGeometry(paths.cased, 72, RADII.casedShell, 16, false),
  ...
  const cased = new THREE.Mesh(new THREE.TubeGeometry(paths.cased, 96, RADII.cased, 20, false), mats.cased);
  cased.name = 'cased';
  group.add(cased);
